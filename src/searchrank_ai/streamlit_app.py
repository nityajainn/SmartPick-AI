...
def main() -> None:
    st.set_page_config(page_title="SmartPick-AI", page_icon="🔎", layout="wide")
    st.title("SmartPick-AI")
    st.caption("Product choices, backed by catalogue evidence.")
    st.caption("Current catalogue: smartphones")
    client = _client()
    _show_health(client)
