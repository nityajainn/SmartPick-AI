...
Adapted for SmartPick-AI on 2026-09-14. The source report below records the original 2026-09-05
measurements, including model-build timings and artifact reproducibility. Those timings are
historical results, not new SmartPick-AI measurements. Current validation is recorded in
[the evaluation log](EVALUATION.md).
