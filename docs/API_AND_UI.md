...
Adapted for SmartPick-AI on 2026-09-17 from the reviewed SearchRank-AI Phase 6 snapshot
`f5718cf`. Public titles use SmartPick-AI; internal package and environment names are retained.
The project targets product search and comparison, with smartphones as the first validated category.
